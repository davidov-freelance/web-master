;( function( $, window, document, undefined ) {
    ...
    $.extend( WeekPicker.prototype, {
        ...
        onSelect: function( dateText, dpInstance ) {
            ...
            if (instance.settings.onSelectCallback) {
                instance.settings.onSelectCallback(dateText, instance);
            }
        }
    } );
    ...
    var createWeekPickerInput = function( datePickerInput ) {
        ...
        var datePickerValue = datePickerInput.val();
        var weekPickerInput = $( "<input type=\"text\" id=\"" + weekPickerId +
            "\" data-datepicker-id=\"" + datePickerId + "\" value=\"" + datePickerValue + "\">" );
