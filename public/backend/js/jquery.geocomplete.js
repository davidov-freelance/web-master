  ...
  $.extend(GeoComplete.prototype, {
    ...
    initMap: function(){
      ...
      google.maps.event.addListener(
        ...
        'click',
         function(a) {
			 var lattitude	=	a.latLng.lb;
			 var longitude	=	a.latLng.mb;
			 //alert('Latitude: '+lattitude+'\n Longitude: '+longitude);
			 document.getElementById("deals_longitude").value=longitude;
			 document.getElementById("deals_latitude").value=lattitude;
 // console.log(a.latLng.lb);
 // console.log(JSON.stringify(a.latLng));
	//console.log(Object.prototype.toString.call(a.latLng));
    // bingo!
