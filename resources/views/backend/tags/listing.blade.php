                            ...
                            <table id="datatable" class="table table-striped table-bordered" data-form="deleteForm">
                                ...
                                @foreach( $tags as $record )
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="{{ backend_url('tags/edit/'.$record->id) }}" class="btn btn-info btn-xs edit" style="float: left;"><i class="fa fa-pencil"></i> </a>

                                            {!! Form::model($record, ['method' => 'delete', 'url' => 'backend/tags/'.$record->id, 'class' =>'form-inline form-delete']) !!}
