        ...
        <div class="">
            <div class="page-title">
                <div class="title_left">
                    {{--<h3>Fields Of Work -  List <small></small></h3>--}}
                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Fields Of Work <small></small></h2>
                            ...
                            <table id="datatable" class="table table-striped table-bordered" data-form="deleteForm">
                                ...
                                @foreach( $fields as $record )
                                    ...
                                    <tr class="">
                                        ...
                                        <td>
                                            <a href="{{ backend_url('fields/edit/'.$record->id) }}" class="btn btn-info btn-xs edit" style="float: left;"><i class="fa fa-pencil"></i> </a>

                                            {!! Form::model($record, ['method' => 'delete', 'url' => 'backend/fields/'.$record->id, 'class' =>'form-inline form-delete']) !!}
